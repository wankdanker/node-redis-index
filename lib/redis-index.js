...
module.exports.closeClient = function (err, client) {
	client.quit();
}
 ...
 * @param  {Function} [opts.createClient] optional function that should return a new redis client
 * @param  {Function} [opts.closeClient] optional function that should handle the closing of a redis client
...
function RedisIndex (opts) {
	...
	self.client = null
	self.createClient = opts.createClient || module.exports.createClient;
	self.closeClient= opts.closeClient || module.exports.closeClient;
