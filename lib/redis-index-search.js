...
RedisIndexSearch.prototype.exec = function (opts, cb) {
	...
	var client = self.index.createClient();
	...
	function processObject(obj, intermediaries, keys) {
		...
		Object.keys(obj).forEach(function (key) {
			//TODO: it would be nice to recursively call processObject for encountered objects
			//following the structure of schema rather than have to use a flatSchema. It would
			//work similar to how we do it when indexing an object
			var schema = self.index.flatSchema[key] || {};
			var keys2 = [];
			var valIsDate;
			var valIsNumber;
			var valIsString;
